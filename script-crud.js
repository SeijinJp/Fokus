const btmAdicionarTarefa = document.querySelector('.app__button--add-task')
...
btmAdicionarTarefa.addEventListener('click', () => {
...
const removerTarefas= (somenteCompletas) => {
    ...
    tarefas = somenteCompletas ? filter(tarefa => !tarefa.completa) : []
    atualizarTarefas();
}
